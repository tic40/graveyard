...
export const replaceNewLineToBrTag = (message: string): string => {
  return message.replace(/\n/g, ' <br>')
}

export const replaceBrTagToNewLine = (message: string): string => {
  return message.replace(/\<(br \/|br)\>/g, '\n')
}

export const replaceHttpLinkToHttps = (url: string): string => {
